...
// function InstagramPost({ mediaUrl, mediaType, alt, permalink }) {
//   return (
//     <a href={permalink} target="_blank" rel="noopener noreferrer" className="palji_instagram_post">
//       {mediaType === "IMAGE" ? (
//         <img src={mediaUrl} alt={alt} className="palji_post_image" />
//       ) : (
//         <video src={mediaUrl} className="palji_post_image" muted loop playsInline />
//       )}
...
//         .slice(0, 5) // Only show 5 most recent posts
...
//             <button
//               onClick={scrollLeft}
//               className={`palji_nav_button palji_nav_left ${scrollPosition <= 10 ? "palji_nav_disabled" : ""}`}
//               disabled={scrollPosition <= 10}
//               aria-label="Scroll left"
//             >
//               <LeftArrowIcon />
//             </button>
//             <button onClick={scrollRight} className="palji_nav_button palji_nav_right" aria-label="Scroll right">
//               <RightArrowIcon />
//             </button>
//           </>
//         )}
...
//         <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="palji_follow_button">
//           <InstagramIcon />
//           Follow on Instagram
//         </a>
//       </div>
