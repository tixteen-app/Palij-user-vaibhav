...
bWVzdGFtcAAyMDIzLTAyLTEzVDEzOjE1OjUxKzAwOjAwIIO3fQAAAABJRU5ErkJggg=="
        ...
        :
        // <div className='main_login_page_div main_send_mail_to_email' >
        //   <form className="update_password_main_div" >
        //     <p className="update_password_text text-center">Update Password </p>
        ...
        <div className="form-container-forgot-password">
          ...
          <form className="form-forgot-password">
           ...
           :  
              // <div>
                <button type="submit" className="submit btn btn-dark px-5 py-3"  onClick={(e) => handleSubmitPassword(e)} >Update Password</button>
              // </div>
            }
