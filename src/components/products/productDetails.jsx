...
// import { addToCart, removeFromCart, fetchCart,addToCartCake } from "../../utils/productFunction.js";
...
//   const [visibleImages, setVisibleImages] = useState(4); // Default to 4 images
...
//         setProductLoaders,
//         selectedSize._id,
//         tempCakeMessage // Pass the cake message
//       );
//       setShowCakeMessagePopup(false);
//       setTempCakeMessage("");
//     } catch (error) {
...
//     // Check if product is in cake category
//     if (product?.category?._id === "67b451f7ec3a4e4a3bbe5633" && !isInCart) {
...
//     }
//     try {
//       await addToCartCake(productId, setIsLogin, setShowPopup, fetchCartItems, setCartItems, setProductLoaders, selectedSize._id);
//       navigate('/cart');
//     } catch (error) {
//       console.error("Error adding to cart:", error);
//     }
...
//                         <textarea
//                           className="message_popup_cake__textarea"
//                           value={tempCakeMessage}
//                           onChange={(e) => setTempCakeMessage(e.target.value)}
//                           placeholder="Enter your cake message (max 20 characters)"
//                           maxLength={20}
//                         />
//                         <div className="message_popup_cake__buttons">
//                           <button
//                             className="message_popup_cake__button message_popup_cake__skip"
//                             onClick={() => {
//                               setShowCakeMessagePopup(false);
//                               handleIncreaseQuantity();
//                             }}
...
//                           </button>
//                           <button
//                             className="message_popup_cake__button message_popup_cake__save"
//                             onClick={handleAddToCartWithMessage}
//                             disabled={isAddingToCart}
//                           >
//                             {isAddingToCart ? 'Saving...' : 'Save & Add to Cart'}
//                           </button>
//                         </div>
//                       </div>
//                     </div>
